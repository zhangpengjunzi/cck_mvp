...
public class StateLayout extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        if (progressViewId != -1) {
            ...
            progressBar = (ProgressWheel) progressView.findViewById(R.id.progress_wheel);
        ...
        if (shouldPlayAnim) {
            if (toBeHided != null) {
                if (hideAnimation != null) {
                    if(toBeHided==contentView&&toBeShown==progressView&&toBeHided.getVisibility()==View.VISIBLE){
                        toBeHided.setVisibility(View.VISIBLE);
                    }else{
                        hideAnimation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                toBeHided.setVisibility(View.GONE);
                            }
                    ...
                    setProperty(toBeShown,toBeHided);
            }
            if (toBeShown != null) {
    ...
    private void setProperty(View show,View hide){
        if(hide==contentView&&show==progressView&&hide.getVisibility()==View.VISIBLE){
